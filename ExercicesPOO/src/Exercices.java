...
public class Exercices {
	...
	public static void main(String[] args) {
		...
		Enseignant prof_david = new Enseignant("David", "...", 12234);
		Enseignant prof_shany = new Enseignant("Shany", "...", 45612);
		Enseignant prof_maxime = new Enseignant("Max", "...", 32145);
		Enseignant prof_georges = new Enseignant("George", "...", 65478);
		
		
		HashMap map = new HashMap<Integer , String>();
		
		map.put(prof_david.getNumero_employe(), prof_david);
		map.put(prof_shany.getNumero_employe(), prof_shany);
		map.put(prof_maxime.getNumero_employe(), prof_maxime);
		map.put(prof_georges.getNumero_employe(), prof_georges);
		
		
		if(map.containsKey(prof_maxime.getNumero_employe()) == true) {
			// ok c'est bon il existe!
			map.get(prof_shany.getNumero_employe());
		}
